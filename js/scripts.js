...
function paginaIndex() {
    ...
    /*
    Significa: Se não existir a variavel (progressao) OU não existir a variavel(recrutamento), pare a função aqui. Isso evita de outras paginas do projeto executarem esse script atoa e até ocasionar erros por causa disso. 
    */
...
paginaIndex() /* Chama a função para ser executada, sem isso tudo que está dentro da função não vai funcionar.  */
